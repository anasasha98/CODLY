                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="" class="row g-3 needs-validation">
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="email" class="form-control" id="yourEmail" required maxlength="50">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" required maxlength="50">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="sign-in.html">Log in</a></p>
                    </div>
                  </form>
