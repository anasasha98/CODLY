  ...
  <main id="main" style="padding-top: 60px;">
    <div class="container-xl px-4 mt-4">
      ...
      <nav class="nav nav-borders">
        ...
        <a class="nav-link" href="purchase-copy.php?captainusername=<?php echo $captainusername; ?>">Purchased Service</a>
      </nav>
      <hr class="mt-0 mb-4">
      ...
      if (isset($_POST['save'])) {
        ...
        $query = "SELECT `password` FROM `captain` where `captainusername` = '$captainusername' ";
        ...
        if ($psw0 == $row['password']) {
          // Update DB 
          $chnage = "UPDATE `captain` SET `password`='$psw' WHERE `captainusername` = '$captainusername'";
          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="captain-security-page.php" enctype="multipart/form-data">
